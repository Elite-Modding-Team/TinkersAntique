...
public class EmbossmentChisel extends Item {

  public EmbossmentChisel() {
    super();
  ...
  public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
    tooltip.addAll(LocUtils.getTooltips(Util.translate("item.tconstruct.embossment_chisel.tooltip")));
