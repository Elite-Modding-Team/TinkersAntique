...
public class EntityMeltingRecipeWrapper implements IRecipeWrapper {
  ...
  public void drawInfo(@Nonnull Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
   // String info = entity.toString();//inputs.get(0).get(0).getDisplayName();
    ...
    if (entityInst != null) {
	  ...
	  GuiInventory.drawEntityOnScreen(x, y, (int) Math.round(renderScale), x - mouseX, y - mouseY, entityInst);
